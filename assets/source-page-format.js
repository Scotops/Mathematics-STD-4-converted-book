...
(function () {
  ...
  var inclusivityPatches = {
    ...
    128: [
      { x: 131, y: 738, w: 478, h: 48, lineHeight: '1.02', html: 'Use accessible tools to show <span class="source-facsimile-fraction"><span>2</span><span>5</span></span> on a diagram by drawing five equal boxes as shown in the following diagram:' }
    ],
    130: [
