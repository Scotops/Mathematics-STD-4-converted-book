  ...
  function addInclusivityPatches(content, physicalPage) {
    ...
    function fitPatchText() {
      ...
      Array.prototype.forEach.call(layer.querySelectorAll('.source-facsimile-fraction'), function (fraction) {
        fraction.style.cssText = 'display:inline-flex;position:relative;top:-0.36em;flex-direction:column;align-items:center;justify-content:center;margin:0 .08em;line-height:.82;font-size:1.08em;vertical-align:baseline;';
