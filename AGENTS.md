# Mathematics Pupil's Book Standard Four — ADT Bundle Reference
...
**Mathematics Pupil's Book Standard Four** — This is an English-language Grade 4 mathematics pupil’s book from Tanzania, published by the Tanzania Institute of Education for primary schools following the 2023 syllabus. It covers core upper-primary topics such as Roman numerals, multiplication and division, measurement, perimeter, area, fractions, decimals, time, and Tanzanian currency, with many worked examples, exercises, and everyday word problems. The book uses a competency-based, practical approach that emphasizes logical thinking, problem solving, and applying math to daily life, often encouraging discussion, activities, and use of online learning resources.
...
```
MATHEMATICS-STD-4-PB--SEPT-2025-/
├── adt/                              # THE WEB APP
...
├── MATHEMATICS-STD-4-PB--SEPT-2025-.db                    # SQLite database (pipeline state)
├── MATHEMATICS-STD-4-PB--SEPT-2025-.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg140_im002` |
...
{
  "pg001_gp001_tx001": "",
  "pg140_im002": "Example 2 0.5 + 0.2 = Steps 1. Add the digits to the right of the decimal point, 5 + 2 = 7. Write 7 in the decimal place. 2. Add the whole numbers: 0 + 0 = 0. Write 0 in the place for the whole number. 0.5 + 0.2 0.7 Therefore, 0.5 + 0.2 = 0.7.",
  "gl001": "24 hours format",
  "gl001_def": "a way of writing time using numbers from 00:00 to 23:59"
}
```
...
{
  "24 hours format": {
    "word": "24 hours format",
    "definition": "a way of writing time using numbers from 00:00 to 23:59",
    "variations": ["24 hour format","24 hours format"],
    "emoji": "🕛🔢"
  }
}
```
...
```json
{
  "title": "Mathematics Pupil's Book Standard Four",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-US"
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg140_im002" src="images/pg140_im002.png" ...>
...
| Original PDF | `MATHEMATICS-STD-4-PB--SEPT-2025-.pdf` |
| Pipeline database | `MATHEMATICS-STD-4-PB--SEPT-2025-.db` (SQLite) |
